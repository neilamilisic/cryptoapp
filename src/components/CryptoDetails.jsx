...
import { MoneyCollectOutlined, DollarCircleOutlined, FundOutlined, ExclamationCircleOutlined, StopOutlined, CheckOutlined, NumberOutlined, ThunderboltOutlined } from '@ant-design/icons'
        ...
        <Col className="coin-links">
            ...
            {cryptoDetails.links.map((link) => (
              <Row className="coin-link" key={link.name}>
                ...
                <a href={link.url} target="_blank" rel="noreferred">
                  {link.name}
                </a>
              </Row>
            ))}
